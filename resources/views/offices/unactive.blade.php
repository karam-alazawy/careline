@extends('layouts.app', [
    'class' => 'sidebar-mini ',
    'namePage' => 'unactiveOffices',
    'activePage' => 'unactivateOffices',
    'activeNav' => '82',
])
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            ...
            <h4 class="card-title">Unactive Offices</h4>
          ...
          <div class="card-body">
            ...
            <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
              ...
              @foreach($offices as $key => $data)
                    ...
                    <td>{{$data->officeLang->office_name}}</td>
                    <td>{{$data->countryLang->name}}</td>
                    ...
                    <td class="text-right">
                        <a type="button" href="{{ route('office.unactive',[$data->id]) }}" rel="tooltip" class="btn btn-success btn-icon btn-sm " data-original-title="" title="">
