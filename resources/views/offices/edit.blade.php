@extends('layouts.app', [
    'class' => 'sidebar-mini ',
    'namePage' => 'Edit Office',
    'activePage' => 'editOffice',
    'activeNav' => '',
])
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h5 class="title">{{__("Edit Office")}}</h5>
          </div>
          <div class="card-body">
            <form method="POST" action="{{ route('office.editTheOffice',[$office->id]) }}" autocomplete="off"
                    ...
                    <div class="col-md-7 pr-1">
                        <div class="form-group">
                            <label>{{__("Office Name")}}</label>
                                <input type="text" name="name" class="form-control" value="{{$office->officeLang->office_name}}">
                ...
                <!-- <div class="row">
                  <div class="col-md-7 pr-1">
                    <div class="form-group">
                      ...
                      <input type="text" name="province" class="form-control" placeholder="ex: baghdad" value="{{$office->office_province}}">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">{{__(" Country and Province")}}</label>
                     ...
                     <div class="col-xs-4 officeSelect">
                        <select onload="loadImage()" onchange="getProvince()" name="country" id="CountrySelect" class="form-control">
...
//$('#CountrySelect option[value="113"]').attr("selected",true);
